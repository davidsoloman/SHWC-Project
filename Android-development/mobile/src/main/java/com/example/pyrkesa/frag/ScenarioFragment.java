/*
 * ScenarioFragment : This class is used to display all scenario list with the adapter class
 *
...
public class ScenarioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.scenario_fragment, container, false);
    ...
    class LoadAllScenario extends AsyncTask<Void, String, ArrayList<Scenario>> {
        ...
        protected ArrayList<Scenario> doInBackground(Void... args) {
            ...
            String url=model.api_url+"Scenario/get_all_users.php";
