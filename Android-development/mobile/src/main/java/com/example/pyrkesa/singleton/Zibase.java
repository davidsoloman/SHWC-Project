...
/*
 * Zibase : This class is used to manage a Zibase box. This class extends the abstract box class and
 * Authenticate and Action methods are needed. According to the type of box those methods will change,
 * you can see our job to create your box class and make this application compatible with our application.
 *
